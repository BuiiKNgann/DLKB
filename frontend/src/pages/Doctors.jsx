  ...
  return (
    <div className="text-gray-600">
      <p className="text-lg font-medium text-gray-700 mb-6">
        Khám phá các bác sĩ theo chuyên khoa
      </p>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-1/4">
          <button
            className={`w-full py-2 px-4 rounded-lg text-sm font-medium transition-all lg:hidden ${
              showFilter
          ...
          <div
            className={`w-full bg-white rounded-lg shadow-md p-4 mt-4 lg:mt-0 ${
          ...
          >
            {[
              ...
              <button
                ...
                className={`w-full py-2 px-4 rounded-lg text-sm font-medium transition-all mb-4 ${
                  speciality === spec
        ...
        <div className="w-full lg:w-3/4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filterDoc.map((item, index) => (
              ...
              >
                <img
                  className="w-full h-42 object-cover bg-blue-50"
                  src={item.image}
                  alt={item.name}
                />
                <div className="p-2">
