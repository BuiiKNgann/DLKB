...
const DoctorAppointments = () => {
  ...
  const [showCancelModal, setShowCancelModal] = useState(false); //Lưu ID của lịch hẹn cần hủy.
  const [selectedAppointmentId, setSelectedAppointmentId] = useState(null);
  const [cancelReasons, setCancelReasons] = useState([]); //Mảng chứa các lý do hủy được chọn
  const [customReason, setCustomReason] = useState(""); //Chuỗi lưu lý do tùy chỉnh nếu chọn "Lý do cá nhân khác".
  ...
  const handleConfirmCancel = () => {
    ...
    if (
      ...
      //Nếu chọn "Lý do cá nhân khác" và customReason không rỗng, nhãn "Lý do cá nhân khác" được xóa khỏi reasonsToSend, và customReason được thêm vào.
              ...
              {item.cancelled ? (
                ...
                <div className="flex gap-2">
                  ...
                  <img
                    ...
                    alt="Hủy"
                  />
                  {/* hàm completeAppointment được gọi với tham số là ID của lịch hẹn (item._id) */}
                  <img
