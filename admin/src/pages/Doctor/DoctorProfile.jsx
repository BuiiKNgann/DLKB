...
//           <div>
//             <img
//               className="bg-seconds/80 w-full sm:max-w-64 rounded-lg "
...
//                 className="px-4 py-1 border border border-seconds text-sm rounded-full mt-5 hover:bg-seconds hover:text-white transition-all"
//               >
//                 Save
//               </button>
//             ) : (
